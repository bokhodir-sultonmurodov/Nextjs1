          ...
          {posts?.posts?.map((post: IPost) => (
            ...
            >
              ...
              <button
                ...
                className="mt-1 px-3 py-1 text-xs cursor-pointer text-gray-700 bg-gray-300 rounded-full hover:bg-gray-400 transition-all shadow-sm"
              >
                Learn more
              </button>
